                        ...
                        <div class="card-body p-5">
                            ...
                            <form method='POST'>
                                ...
                                <div class="form-outline mb-4">
                                    ...
                                    <label class="form-label" for="form3Example4cg">Account</label>
                                    <div class="form-notch"><div class="form-notch-leading"></div><div class="form-notch-middle"></div><div class="form-notch-trailing"></div></div></div>
                                ...
                                <p class="text-center text-muted mt-5 mb-0">Have already an account? <NavLink to="/dang-nhap" class="fw-bold text-body"><u>Login here</u></NavLink></p>
                            </form>
                        </div>
                    </div>
                </div>
